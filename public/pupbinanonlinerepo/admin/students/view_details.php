		...
		<div class="row">
			...
			<div class="col-6">
				<dl>
					...
					<dt class="text-navy">Submitted ID / COR:</dt>
					<dd class="pl-4">
						<?php if(!empty($id_doc_url)): ?>
							<?php if(preg_match('/\.pdf(\?|$)/', $id_doc_url)): ?>
								<a href="<?= $id_doc_view_url ?>" target="_blank" class="btn btn-sm btn-primary">View PDF</a>
							<?php else: ?>
								<img src="<?= $id_doc_view_url ?>" alt="ID Document" class="img-fluid border">
							<?php endif; ?>
						<?php else: ?>
							<span class="text-muted">None</span>
						<?php endif; ?>
					</dd>
					<dt class="text-navy">Live Face Photo:</dt>
					<dd class="pl-4">
						<?php if(!empty($live_face_url)): ?>
							<img src="<?= $live_face_view_url ?>" alt="Live Face" class="img-fluid border">
						<?php else: ?>
							<span class="text-muted">None</span>
						<?php endif; ?>
					</dd>
