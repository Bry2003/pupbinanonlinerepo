	...
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					<label for="type_display">User Type</label>
					<input type="text" id="type_display" class="form-control" value="<?php echo (isset($meta['type']) && $meta['type'] == 1) ? 'Administrator' : 'Adviser' ?>" readonly>
				</div>
				<div class="form-group col-6">
	...
	$('#manage-user').submit(function(e){
		...
		$.ajax({
            ...
            success:function(resp){
                if(resp ==1){
                    showSignupLoader("Account created successfully. Redirecting...", './?page=user/list');
                }else{
