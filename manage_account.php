            ...
            <div class="container-fluid">
                <form action="" id="update-form">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-auto">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="genderMale" name="gender" value="Male" required <?= isset($gender) && $gender == "Male" ? "checked" : "" ?> disabled>
                                <label for="genderMale" class="custom-control-label">Male</label>
                            </div>
                        </div>
                        <div class="form-group col-auto">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="genderFemale" name="gender" value="Female" <?= isset($gender) && $gender == "Female" ? "checked" : "" ?> disabled>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="id_number" class="control-label text-navy">ID Number</label>
                                <input type="text" name="id_number" id="id_number" placeholder="ID Number" class="form-control form-control-border" value="<?= isset($id_number) ? $id_number : "" ?>">
                            </div>
                            <div class="form-group">
                                <label for="email" class="control-label text-navy">Email</label>
                                <input type="email" name="email" id="email" placeholder="Email" class="form-control form-control-border" required readonly value="<?= isset($email) ?$email : "" ?>">
                            </div>
                            <div class="form-group">
