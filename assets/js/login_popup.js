        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #800000; color: white;">
                    <h5 class="modal-title text-white" id="loginRequiredModalLabel">Login Required</h5>
                    <button type="button" class="close text-white" onclick="closeLoginPopup()" aria-label="Close">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn" style="background-color: #800000; color: white;" onclick="redirectToLogin()">Login</button>
