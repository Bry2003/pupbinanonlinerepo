...
<div class="card card-outline card-primary">
	<div class="card-header">
        ...
        <div class="card-tools">
            <button class="btn btn-flat btn-primary btn-sm" id="create_new"><i class="fa fa-plus"></i> Create New</button>
        </div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><p class="m-0 truncate-1"><?php echo isset($row['username']) && $row['username'] !== '' ? $row['username'] : '—'; ?></p></td>
...
<script>
	$(document).ready(function(){
        $('.action_menu_btn').click(function(){
            ...
            uni_modal('Actions', 'inc/action_menu.php?context=students&id=' + id + '&status=' + status);
        })
        ...
        $('#create_new').click(function(){
            uni_modal('Add New Student', "students/manage_student.php", 'mid-large')
        })
		$('.table').dataTable();
    ...
    // Alias expected by action_menu.php confirmation callback
