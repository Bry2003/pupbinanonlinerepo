						...
						<tr>
							...
							<td class="text-center">
                                <img src="<?php echo validate_image($row['avatar']) ?>"
                                     class="img-avatar img-thumbnail p-0 border-2 user-avatar-view"
                                     alt="user_avatar">
                            </td>
							<td><?php echo ucwords($row['name']) ?></td>
							<td ><p class="m-0 truncate-1"><?php echo $row['username'] ?></p></td>
							<td ><p class="m-0"><?php echo ($row['type'] == 1 )? "Administrator" : "Adviser" ?></p></td>
                            <td align="center">
...
<script>
	$(document).ready(function(){
        $('.action_menu_btn').click(function(){
            ...
            uni_modal('Actions', 'inc/action_menu.php?context=user&id=' + id + '&status=' + status);
        })
        $('.user-avatar-view').click(function(){
