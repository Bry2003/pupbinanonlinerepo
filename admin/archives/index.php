		...
		<div class="container-fluid">
			<div class="container-fluid">
                <?php 
                    ...
                    $years = $conn->query("SELECT DISTINCT YEAR(date_created) AS year FROM archive_list WHERE date_created IS NOT NULL ORDER BY YEAR(date_created) DESC");
				...
				<tbody>
					<?php 
                        ...
                        if(!empty($year)){
                            ...
                            $where .= (empty($where) ? " WHERE " : " AND ") . " YEAR(a.date_created) = '{$yr}'";
                        }
                        ...
                        $sql = "SELECT a.*, d.name AS program_name, d.id AS program_id, sd.name AS student_program, sd.id AS student_program_id,
                                ...
                                ".$where." ORDER BY a.date_created DESC, a.title DESC";
                        $qry = $conn->query($sql);
