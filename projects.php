            ...
            <div class="card-body rounded-0">
                ...
                if(isset($_GET['q'])){
                    ...
                    $search = " and (title LIKE '%{$keyword}%' 
                        ...
                        or curriculum_id in (SELECT id from department_list where name  LIKE '%{$keyword}%' or description  LIKE '%{$keyword}%')) ";
                }
                ...
                $cnt_q = $conn->query("SELECT COUNT(*) AS c FROM archive_list where `status` = 1 {$search}");
