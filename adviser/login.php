...
<head>
    ...
    <title>Adviser Login | <?php echo $_settings->info('name') ?></title>
    ...
    <div class="central-card animate__animated animate__fadeInUp">
        ...
        <div class="card-left">
            ...
            <div class="info-subtitle">
                ADVISER PORTAL<br>
                Guidance and mentorship for student excellence.
            </div>
        </div>
        ...
        <div class="card-right">
            ...
            <form id="adviser-login-frm" action="" method="post">
...
<script>
  $(document).ready(function(){
    $('#adviser-login-frm').submit(function(e){
        e.preventDefault()
        var _this = $(this)
        ...
        $.ajax({
            url:_base_url_+'classes/Login.php?f=login_adviser',
            method:'POST',
            data:$(this).serialize(),
            error:err=>{
                console.log(err)
